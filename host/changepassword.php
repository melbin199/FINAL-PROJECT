...
$qry="select login_id,password from login where username='$name' and type='host'";
  ...
  if($password==$currentpassword)
{
    ...
    {
        $qry1 ="update login set password='$confirmpassword' where login_id='$id' and type='host'";
$res=mysqli_query($con,$qry)or die($qry);;
...
<head>
    ...
    <title>Host change password</title>
                        ...
                        <form  method="post">
                            <div class="form-inputs">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-8">
                                        <input autocomplete="new-password" class="form-control" id="new_password" name="newpassword" type="password" required="">
                                    </div>
                                </div>
                                <div class="form-group">
