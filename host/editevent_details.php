...
$con=mysqli_connect("localhost","root","","project");
   ...
   $sql0="select login_id from login where username='$uname' and type = 'host'";
...
$sql1="SELECT * FROM host where host_id = '$host_id'";
...
<body id="page-top">
                            ...
                            <form method="POST" class="user">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                     <input type="text" class="form-control form-control-user" name="license" id="license"  value="<?php echo $row['owner_name'];?>" required placeholder=" Owner Name" maxlength="12" />
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            ...
                                            value="<?php echo $row['location'];?>" placeholder="location" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" 
                                 ...
                                 <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="license_no" id="email"
                                        value="<?php echo $row['license_no'];?>" placeholder="license number" required>
                                </div>
 ...
 <?php
      ...
      $query = "UPDATE host SET license_no = '$license',
                      phone = '$phone', email = '$mail', location = '$location',pincode='$pincode'
        ...
        <?php
         echo "<script>window.open('host_index.php','_self')</script>";
