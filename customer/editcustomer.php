...

{
  ...
  $sql="select host_id from host where owner_name='$uname'";
   $res=mysqli_query($con,$sql)or die($sql);
   $row=mysqli_fetch_array($res);
   $login_id=$row['host_id'];
  ...
  $sql="update host set pincode='$pincode',location='$location',license_no='$license' where host_id= $login_id";
  mysqli_query($con,$sql)or die($sql);

 
   $sqli="insert into events (host_id,event_name,event_type,title,cost) values($login_id,'$event_name','$event_type','$title',$cost)";  
  ...
  header("location:customer_index.html");
mysqli_close($con);
}  
?>
<!DOCTYPE html>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Edit Details</a>
