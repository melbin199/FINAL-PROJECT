...
{
	$id=$_POST['result'];
	$sql="update event_booking set status=0, paystatus= 'REFUND', remark='Order has been Cancelled by User' where event_id=$id and booking_id= (select booking_id from event_booking where event_id=$id and status=1 Limit 1)";
...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<div class="container">
			...
			<center><h2 class="heading-agileinfo"><br><br>MY ACTIVITY<span><hr>Events is a professionally managed Event</span></h2></center>
