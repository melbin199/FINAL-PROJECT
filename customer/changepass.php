...
$qry="select login_id,password from login where username='$name' and type='customer'";
  ...
  if($password==$currentpassword)
{
    ...
    {
        $qry1 ="update login set password='$confirmpassword' where login_id='$id'";
                            ...
                            <div class="form-inputs">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-8">
                                        <input autocomplete="current-password" class="form-control" id="current_password" name="currentpassword" required type="password" onblur="validatePassword()">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-3 col-md-4" for="new_password">New Password:</label>
                                    <div class="col-sm-9 col-md-8">
                                        <input autocomplete="new-password" class="form-control" id="new_password" name="newpassword" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-3 col-md-4" for="password_confirmation">Confirm Password:</label>
                                    <div class="col-sm-9 col-md-8">
                                        <input autocomplete="new-password" class="form-control" name="confirmpassword" type="password" required="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions text-left col-md-4">
