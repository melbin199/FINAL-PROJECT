...
$sql="SELECT login_id from login where username='$uname' and type = 'customer'" ;
$res1=mysqli_query($con,$sql)or die($sql);
$row1=mysqli_fetch_array($res1);
$customer_id=$row1['login_id'];

$sql2="SELECT * from Customer where login_id ='$customer_id'";
$res2=mysqli_query($con,$sql2)or die($sql2);
$row=mysqli_fetch_array($res2);
$customer_idd=$row['customer_id'];

$sql5="SELECT * from events";
$res5=mysqli_query($con,$sql5)or die($sql5);
...
// echo "$eventname";
  ...
  $sql3="select Count(*) from event_booking where status=1 and customer_id = '$customer_idd' and buy=0";
  $result1=mysqli_query($con,$sql3)or die("number query moonchi");
  $row2=mysqli_fetch_array($result1);
  $cart=$row2['Count(*)'];

// $sql1="SELECT * FROM Customer where customer_name='$uname'";
// $res=mysqli_query($con,$sql1)or die($sql1);
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Edit Details</a>
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" class="user">
                                ...
                                <select name="about" class="form-control " placeholder="" id="about" required="" style="height: 47px;">
                                    <?php
                                    while($row5 = mysqli_fetch_array($res5)) 
                                    {
                                        $eventname = $row5['event_name'];
                                ...
                                <div class="form-group">
                                 <select name="title" class="form-control" required="" style="height: 47px;">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="description"
                                     placeholder="Description" required="" style="height: 80px;" minlength="10" maxlength="200">
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="point"
                                     placeholder="Rate 1 - 10" required maxlength="1">
                                </div>
                ...
                $con=mysqli_connect("localhost","root","","project");   
                    ...
                    {
                         $event_name=$_POST["about"];
                         $title=$_POST["title"];
                         $description=$_POST["description"];
                         $point=$_POST["point"];
                         // $customer_idd

                    $sqli="insert into feedback (customer_id,about,title,description,rating) values($customer_idd,'$event_name','$title','$description','$point')";  
                        mysqli_query($con,$sqli)or die($sqli);

                     ?>
                     <script>
                         alert("Your feedback is reported");
                     </script>
                     <?php
                      echo "<script>window.open('customer_index.php','_self')</script>";
