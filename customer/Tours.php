...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<div class="container">
			...
			<center><h2 class="heading-agileinfo"><br><br>Tours and Travels<span><hr>Events is a professionally managed Event</span></h2></center>
			
            <div id="wrap">
	<div id="columns" class="columns_4">
		<?php
			$con=mysqli_connect("localhost","root","","project");
			$sql="select * from events where event_type='tours' and status = 1 and approve = 1";
  ...
  <img src="../image/<?php echo $row['pic1'];?>" >
	<figcaption><h4><?php echo $row['event_name']?></h4></figcaption>
    <span class="price" >INR ₹ <?php echo $row['cost'] ?></span><br>
    <center>
    	<input type="submit" name="submit" class="btn btn-warning" onclick="one('<?php echo $row['event_id'] ?>')" value="book now">
    </center>
