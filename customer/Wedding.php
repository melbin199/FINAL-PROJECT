...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<div class="container">
			...
			<center><h2 class="heading-agileinfo"><br><br>Wedding<span><hr>Events is a professionally managed Event</span></h2></center>
			
            <div id="wrap">
	<div id="columns" class="columns_4">
		<?php
			$con=mysqli_connect("localhost","root","","project");
			$sql="select * from events where event_type='wedding' and status = 1 and approve = 1";
