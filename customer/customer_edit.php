...
<body id="page-top">
                            ...
                            <form method="POST" class="user">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                     <input type="text" class="form-control form-control-user" name="cname" id="cname"  value="<?php echo $row['customer_name'];?>" required placeholder=" Customer name" maxlength="20" />
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" name="phone" id="phone"
                                            value="<?php echo $row['phone'];?>" required placeholder="phone" maxlength="10">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" 
                                        value="<?php echo $row['state'];?>" name="state" placeholder="State" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            ...
                                            value="<?php echo $row['district'];?>" placeholder="District" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" 
                                        value="<?php echo $row['pincode'];?>" name="pincode" placeholder="Pincode" required>
                                    </div>
                                </div>
 ...
 <?php
      ...
      $query = "UPDATE Customer SET customer_name = '$cname',
                      phone = '$phone', email = '$mail', address = '$address',state='$state',district='$district',pincode='$pincode'
                      WHERE login_id = '$customer_id'";
